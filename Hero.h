...
private:
    ...
    Hero(const std::string _name, float _HP, float _pysicalDMG, float _magicalDMG, float _ACD, float _XPToLevelup, float _maxHPBonus, float _DMGBonus, float _ACDBonus);
